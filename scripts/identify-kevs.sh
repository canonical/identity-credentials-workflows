#!/usr/bin/env bash
# This script identifies any CVEs that exist in the current GitHub code scanning
# alerts and are also in the CISA KEV catalog.
#
# args:
#   1. The GitHub repository in the format owner/repo
# output:
#   A list of CVEs that are both in the current GitHub code scanning alerts and
#   in the CISA KEV catalog, one per line
